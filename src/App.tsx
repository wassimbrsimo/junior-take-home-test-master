...
const App: React.FC = () => {
  ...
  const [countryFilterString, setCountryFilterString] = useState<CountryFilterString>('');
    return (
      <Layout>
        <Content>
          <QueryRenderer<AppQuery>
            ...
            query={graphql`
          query AppQuery($patientsSortDirection: String,$countrySortDirection: String,$countryFilterString:String)  {
            clinicalTrials(patientsSortDirection:$patientsSortDirection,countrySortDirection:$countrySortDirection,countryFilterString:$countryFilterString) {
              country
              patients
              site
              city
        ...
        `}
            variables={{patientsSortDirection, countrySortDirection,countryFilterString}}
            render={({props}) => {
              if (!props) {
                return;
              }
